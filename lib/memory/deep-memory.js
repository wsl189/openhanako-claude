...
6. Never extract identity-equivalence claims that rewrite the human user as any agent/member.
   @mentions only indicate addressing someone, not identity reassignment.
