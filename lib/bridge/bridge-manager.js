 ...
 */
const STRIP_TAGS = ["mood", "pulse", "reflect", "mouth", "tool_code", "replying"];
...
export class BridgeManager {
  ...
  _cleanReplyForPlatform(text) {
    ...
    cleaned = cleaned.replace(/```(?:mood|pulse|reflect|mouth|think|analysis|commentary|summary)[\s\S]*?```\n*/gi, "");
    cleaned = cleaned.replace(/<(?:mood|pulse|reflect|mouth|think|analysis|commentary|summary)>[\s\S]*?<\/(?:mood|pulse|reflect|mouth|think|analysis|commentary|summary)>\s*/gi, "");
