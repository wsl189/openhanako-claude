...
/**
 * @param {{ onNotify: (title: string, body: string, opts?: { target?: "local"|"platform"|"auto", platform?: "wechat"|"telegram"|"feishu"|"qq"|null, strict?: boolean }) => Promise<object|void> | object | void }} opts
 */
